...
export default function Timeline({ useAltBg = false }) {
  const { t } = useLanguage();
    ...
    >
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-0">
          {/* Vertical Line */}
          <div className="absolute left-4 md:left-1/2 transform md:-translate-x-1/2 h-full w-0.5 bg-theme-support-1/50" />
            ...
            {Array.isArray(timelineData) &&
              timelineData.map((item, index) => (
                ...
                >
                  ...
                  {/* Content Card */}
                  <div className="w-[calc(100%-2rem)] ml-8 md:ml-0 md:w-5/12 p-6 bg-white rounded-2xl border border-theme-support-1/20 shadow-lg relative z-10">
